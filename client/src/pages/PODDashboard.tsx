...
import { Users, ListMusic, Lightbulb, MessageSquare, ArrowUpRight } from "lucide-react";
...
export default function PODDashboard() {
  ...
  const stats = trpc.dashboard.getStats.useQuery(undefined, { initialData: undefined });
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatCard
          ...
          value="—"
          change="See POD Opportunities"
          icon={<Lightbulb className="h-4 w-4" />}
          description="Identified from comments"
        />
        <StatCard
          title="Comments"
          value={String(commentsCollected)}
          change="Analyzed"
      ...
      <Tabs value={tab} onValueChange={setTab}>
        ...
        <TabsContent value="analytics" className="mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Comment engagement and POD opportunity metrics</CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground">
                Run analyses from <Link href="/" className="text-primary underline">Home</Link> and view results in Intelligence, Comments, and POD Opportunities.
              </p>
            </CardContent>
          </Card>
        </TabsContent>
        <TabsContent value="opportunities" className="mt-4">
          <Card>
            <CardHeader>
              <CardTitle>POD Opportunities</CardTitle>
              <CardDescription>Track identified, validated, and published opportunities</CardDescription>
            </CardHeader>
            <CardContent>
              <Link href="/pod-opportunities">
                <span className="text-primary font-medium underline">Open POD Opportunities →</span>
              </Link>
            </CardContent>
          </Card>
        </TabsContent>
