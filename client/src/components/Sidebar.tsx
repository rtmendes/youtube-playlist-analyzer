...
export function Sidebar({ isCollapsed, onToggle, onOpenSearch, onToggleYouTube, isYouTubeOpen }: SidebarProps) {
  ...
  const navItems = [
    ...
    { icon: FileText, label: "Analysis & Report", href: "/analysis", section: "tools" },
    ...
    { icon: Play, label: "TikTok Intelligence", href: "/tiktok", section: "tools" },
    { icon: BarChart3, label: "Competitor Analysis", href: "/competitor-analysis", section: "tools" },
    { icon: Calendar, label: "Competitor Calendar", href: "/competitor-calendar", section: "tools" },
    { icon: Target, label: "Content Gap Analysis", href: "/content-gap-analysis", section: "tools" },
